  ...
  <div class="full-modal" id="full-modal" :class="[$parent.loader || $parent.mute ? 'overflow-hidden' : 'overflow-auto']">
        <div class="flex min-h-full w-full justify-end relative" >
            ...
            <div id="modal" class="modal relative w-full lg:w-3/5 xl:1/2 bg-gray-300 shadow-2xl pb-16">
                ...
                <div class="fixed py-5 px-8  top-0 text-xl hover:text-red-500 text-gray-300 cursor-pointer z-50 dark transition-all easy-in" @click="closeModal">
                ...
                <div class="dark relative flex items-center justify-center h-[300px] md:h-[400px] px-5 ">
                 ...
                 <div class="md:-mt-[180px] -mt-[130px] relative z-40">
                ...
                <div class="flex flex-wrap justify-center items-center mt-16 z-20 relative">
                    <a v-if="$parent.projets[$parent.indexModal].link" :href="$parent.projets[$parent.indexModal].link" target="_blank">
